          ...
          <div className="w-full max-w-xl space-y-8">
            ...
            <form className="backdrop-blur-sm bg-white/10 p-10 mb-10 rounded-lg border border-gray-200 shadow-lg">
              ...
              <div className="flex mx-auto justify-end mb-10">
                <Link
                  to="/verify"
                  className="text-[#8F5E0A] font-semibold cursor-pointer hover:underline text-end pt-2"
                >
                  Forgot Password?
                </Link>
              </div>
              ...
              <Link to="/login" className="">
                <button className="w-full bg-[#B28D28] p-2 rounded-full text-white text-base font-semibold cursor-pointer">
                  Login
                </button>
              </Link>
