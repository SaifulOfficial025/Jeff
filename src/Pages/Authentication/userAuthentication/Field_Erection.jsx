...
export default function Field_Erection() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-4">
      <div className="w-full max-w-5xl rounded-lg p-6">
        ...
        {step === 4 && (
          <div className="space-y-6">
            <h2 className="text-xl font-semibold text-center text-blue-400 mb-6">Field Erection Capabilities</h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label className="block text-sm">What type of erection crews do you primarily use?</label>
                <div className="relative">
                  <select className="w-full bg-gray-800 border border-gray-700 rounded p-3 pr-10 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-400">
                    <option>Private/Subcontracted</option>
                    <option>In-house</option>
                    <option>Mix of both</option>
                    <option>Varies by project</option>
                  </select>
                  <ChevronDown
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 pointer-events-none"
                    size={20}
              ...
              <div className="space-y-2">
                <label className="block text-sm">What is your crane ownership or access situation?</label>
                <div className="relative">
                  <select className="w-full bg-gray-800 border border-gray-700 rounded p-3 pr-10 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-400">
                    <option>Own Small ({"<"} 50 Tons)</option>
                    <option>Rent All</option>
                    <option>Own Medium (50-100 Tons)</option>
                    <option>Own Large (100+ Tons)</option>
                    <option>Mix of Own/Rent</option>
                  </select>
                  <ChevronDown
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 pointer-events-none"
                    size={20}
              ...
              <div className="space-y-2">
                <label className="block text-sm">What is your aerial lift ownership status?</label>
                <div className="relative">
                  <select className="w-full bg-gray-800 border border-gray-700 rounded p-3 pr-10 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-400">
                    <option>Sufficient Fleet</option>
                    <option>Minimal/Rent Most</option>
                    <option>Rent All</option>
                    <option>Extensive Fleet</option>
                  </select>
                  <ChevronDown
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 pointer-events-none"
                    size={20}
              ...
              <div className="space-y-2">
                <label className="block text-sm">What is the average field labor experience?</label>
                <div className="relative">
                  <select className="w-full bg-gray-800 border border-gray-700 rounded p-3 pr-10 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-400">
                    <option>3 - 7 years</option>
                    <option>Less than 3 years</option>
              ...
              <div className="space-y-2">
                <label className="block text-sm">What is your experience level with complex erections?</label>
                <div className="relative">
                  <select className="w-full bg-gray-800 border border-gray-700 rounded p-3 pr-10 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-400">
              ...
              <div className="space-y-2">
                <label className="block text-sm">What is your site safety planning experience?</label>
                <div className="relative">
                  <select className="w-full bg-gray-800 border border-gray-700 rounded p-3 pr-10 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-400">
                    <option>Basic / General Contractor Reliant</option>
                    <option>Comprehensive In-house</option>
                    <option>Moderate</option>
              ...
              <div className="space-y-2">
                <label className="block text-sm">What is your field welding preference?</label>
                <div className="relative">
                  <select className="w-full bg-gray-800 border border-gray-700 rounded p-3 pr-10 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-400">
                    <option>Minimal / Prefer Bolted</option>
                    <option>Moderate</option>
                    <option>Extensive</option>
