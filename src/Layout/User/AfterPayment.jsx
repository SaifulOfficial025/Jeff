...
const AfterPayment = () => {
    ...
    const pollAiStatus = async (projectId, taskId) => {
      try {
        const response = await fetch(
          `https://indicates-artists-reflect-messages.trycloudflare.com/api/projects/${projectId}/ai_analysis_status/?task_id=${taskId}`,
          {
            headers: {
  ...
  const getProcessedFiles = () => {
    ...
    const backendBaseUrl = 'https://indicates-artists-reflect-messages.trycloudflare.com'; // Use your actual backend URL
