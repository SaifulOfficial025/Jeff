...
import { useBlockVendorMutation, useDeleteVendorMutation, useGetDashboardVendorQuery } from "../../redux/features/baseApi";
import { toast, Toaster } from "sonner";

const VendorsInfo = () => {
  const { data: vendorDashboardInfo, refetch } = useGetDashboardVendorQuery();
  ...
  //block vendor
   const handleToggleBlock = async (id) =>{
    try {
      const res = await blockVendor(id).unwrap();
                    ...
                    <div className="dropdown dropdown-end z-50">
                      ...
                      >
                        <div className="flex flex-col">
                          ...
                          className="flex items-center gap-2 text-sm cursor-pointer text-white hover:bg-gray-700 px-3 py-2 w-full text-left">
                            <MdBlock size={20} />
                          ...
                          <button
                            ...
                            className="flex items-center gap-2 text-sm cursor-pointer text-red-600 hover:bg-gray-700 px-3 py-2 w-full text-left"
                          >
